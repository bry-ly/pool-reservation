...
import { IconAlertTriangle, IconArrowRight, IconShield } from "@tabler/icons-react";
      ...
      <div className="w-full max-w-[400px]">
        <div className="flex flex-col items-center">
          <div className="mb-10 flex flex-col items-center">
            ...
            <div className="inline-flex items-center gap-1.5 border border-border bg-muted/50 px-2.5 py-1 text-[10px] font-medium uppercase tracking-wider text-muted-foreground">
          ...
          <div className="w-full border border-border bg-white dark:bg-black/40 p-8 sm:p-10 shadow-2xl shadow-zinc-200/50 dark:shadow-none">
            <div className="mb-8">
              <h1 className="font-heading mb-2 text-2xl font-medium tracking-tight">Admin Sign In</h1>
              <p className="text-sm text-muted-foreground">Sign in with your administrator account.</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              {error && (
                <div role="alert" className="flex items-start gap-2 border border-destructive/50 bg-destructive/10 px-3 py-2 text-xs text-destructive">
              ...
              <div className="space-y-2">
                <label className="text-muted-foreground/80 text-[11px] font-semibold uppercase tracking-wider" htmlFor="admin-email">
                  Email Address
                </label>
                <Input
                  id="admin-email"
              ...
              <div className="space-y-2">
                <label className="text-muted-foreground/80 text-[11px] font-semibold uppercase tracking-wider" htmlFor="admin-password">
                  Password
                </label>
                <PasswordInput
                  id="admin-password"
